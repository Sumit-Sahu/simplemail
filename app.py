...
def test_api_request():
    ...
    email_content = flask.request.form["body"]

    service = googleapiclient.discovery.build(API_SERVICE_NAME, API_VERSION, credentials=credentials)
    email_from = service.users().getProfile(userId='me').execute()['emailAddress']
    ...
    return '<h3 class="text-center">email send! We love sending email. Send Another</h3>' + render_template("mailform.html")
